...
& $compiler /nologo /target:winexe /platform:x64 /optimize+ /codepage:65001 "/out:$outputDir\CodexPetCredits.exe" "/win32manifest:$projectRoot\src\windows\app.manifest" "/win32icon:$projectRoot\assets\app-icon.ico" @references @sources
